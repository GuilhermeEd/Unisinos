...
public class BST {
  ...
  **/
  ...
  // retornar o valor da maior chave da árvore.
  public int maiorChave() throws UnderflowException{
        if ( isEmpty() ) throw new UnderflowException();
        BSTNode parent = root, n = root;
        while(n != null){
            parent = n;
            n = n.right;
        }
    ...
    // retornar o valor da menor chave da árvore.
    public int menorChave() throws UnderflowException{
        if ( isEmpty() ) throw new UnderflowException();
        BSTNode parent = root, n = root;
        while(n != null){
            parent = n;
