...
public class BST {
  ...
  **/
  ...
  /**
    Retorna o número de nodos folha da árvore
  **/
  ...
  /**
    ...
    publica que sempre inicia a busca pelo nodo raiz
  **/
  public int countLeafNodes(BSTNode n) {
      if ( n == null ) {
          return 0;
      } else {
          boolean isLeaf = (n.left == null && n.right == null);
          return (isLeaf ? 1 : 0) + countLeafNodes( n.left ) + countLeafNodes( n.right );
      }
  }
  ...
  **/
  ...
  /**
    Retornar true caso a árvore esteja cheia ou false caso contrário
  **/
